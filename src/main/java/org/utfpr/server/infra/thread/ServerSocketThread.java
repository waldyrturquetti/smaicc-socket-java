...
public class ServerSocketThread extends Thread {
    ...
    public static void startSocket(Integer port) throws SQLException, DbException {
        ...
        try {
            ...
            ServerInfra.setServerLog(new ServerLog(ServerInfra.getServerSocket().getInetAddress().getHostName(), port, LogScreen.SERVER_TYPE));
            ServerInfra.setServerSocketThread(new ServerSocketThread(ServerInfra.getServerSocket(), ServerInfra.getServerLog()));
        } catch (IOException e) {
    ...
    private ServerSocketThread(ServerSocket serverSocket, LogScreen serverLog) {
